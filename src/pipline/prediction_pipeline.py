...
class VehicleDataClassifier:
    ...
    def predict(self, dataframe) -> str:
        ...
        try:
            ...
            print("self.prediction_pipeline_config.model_bucket_name",self.prediction_pipeline_config.model_bucket_name,)
            print("self.prediction_pipeline_config.model_file_path",self.prediction_pipeline_config.model_file_path)
